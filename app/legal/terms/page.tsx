...
import { getTermsAndConditions, saveTermsAndConditions, LegalContent } from "@/lib/legal-content";
...
export default function TermsAndConditionsPage() {
  ...
  useEffect(() => {
    ...
    setContent(terms);
    setEditedContent(terms.content);
  }, []);
    ...
    return (
      <div className="flex items-center justify-center min-h-screen">
        <div className="text-center">
          ...
          <p className="mt-4 text-white/60">Cargando términos y condiciones...</p>
        </div>
      </div>
    );
  }
    ...
    <div className="max-w-4xl mx-auto space-y-6 py-8">
      ...
      {saved && (
        <div className="rounded-lg bg-green-500/20 border border-green-500/50 p-3">
          <p className="text-sm text-green-400">✓ Términos actualizados correctamente</p>
        </div>
      )}
        ...
        {isEditing ? (
          <div className="space-y-4">
            <p className="text-sm text-white/70">
              Edita el contenido de los términos y condiciones. Usa Markdown para formato.
            </p>
            <textarea
              value={editedContent}
        ...
        <div className="flex items-start gap-3">
          ...
          <div className="flex-1">
            ...
            <p className="text-xs text-white/70 leading-relaxed">
              Al registrarte en Legal PY, DEBES aceptar estos Términos y Condiciones. El registro
              no es posible sin la aceptación de estos términos. Esta es una condición obligatoria
